...
[![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=c-sharp&logoColor=white)](https://learn.microsoft.com/dotnet/csharp/)  [![ASP.NET](https://img.shields.io/badge/ASP.NET-512BD4?style=flat-square&logo=dot-net&logoColor=white)](https://dotnet.microsoft.com/apps/aspnet)  [![Vue.js](https://img.shields.io/badge/Vue.js-35495E?style=flat-square&logo=vuedotjs&logoColor=4FC08D)](https://vuejs.org/)  
...
- Mise en pratique Microsoft DevOps (Azure DevOps/VSTS) : pipelines, release, artefacts.
- Pull requests systématiques + revue de code.
- Intégration qualité : SonarQube Cloud (analyse statique, couverture tests, code smells, dette technique).

> Réalisations clés :
> - API publique pour intégrations plateformes.
> - Amélioration performance backend et stabilité.
> - Automatisation des déploiements.
> - Gouvernance qualité : règles SonarQube, seuils code coverage, plans d’action.

---

### SYNERGY EDITION — Analyste développeur (août 2017 – avril 2018 · 9 mois)

- Support/maintenance produit existant : C#, ASP WebForms, SQL Server, Oracle, Jira.
- Refonte cible : C#, ASP.NET MVC, Web API, Angular, VSTS.
- Travail sur migration fonctionnelle et transversalité des modules.

---

### Groupe SII — Consultant informatique (janv. 2017 – août 2017 · 8 mois)

- Mission chez Synergy Edition (renforcement dev, analyse et bonnes pratiques .NET).

---

### CERECARE — Analyste développeur / Développeur (janv. 2012 – janv. 2017 · 5 ans 2 mois)

- Logiciel traçabilité production/distribution dispositifs médicaux.
- Rédaction cahier des charges, modélisation BD, conception modulaire.
- Développement VB.NET / Windows Forms, PostgreSQL, Team Service.
- Modules : articles/tarifs, production, stock, commandes/facturation SAGE, droits utilisateurs, historique.
- CRM WEB : HTML/CSS/JS/PHP/Symfony2.
- Formation norme EN 62304 (cycle de vie logiciel médical).

---

## 🧩 Projets perso & démonstrations

### [Parenthèse Bien-Être](https://parenthèsebienêtre.fr/) (site vitrine)
- Conception et réalisation du site pour salon de Head SPA privatif [Parenthèse Bien-Être](https://parenthèsebienêtre.fr/).
- Autres livrables : flyers, carte de visite, ressources marketing.
...
- DUT Informatique, Université de Lille (2009 – 2011)
  - Formation polyvalente axée programmation (algorithmes, C, Cobol, Java), bases de données, systèmes d’exploitation, réseaux, génie logiciel et méthodologies de projet.
  - Projets tutorés en équipe, rédaction de cahiers des charges et déploiement d’applications métiers.
  - Acquisition d’une base solide en analyse fonctionnelle, conception d’architectures et qualité logicielle.
